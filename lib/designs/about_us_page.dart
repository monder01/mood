        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                "تم تطوير هذا التطبيق ليكون واجهة إدارية لإدارة تطبيق StudyMon ليقوم على متابعة المستخدمين وإدارة بعض وظائف النظام من مكان واحد، "
                "يوفّر وسيلة عملية للوصول إلى الصفحات الإدارية الأساسية وتنظيم المهام المرتبطة بها، "
                "كما يسهّل التعامل مع الإشعارات ومتابعة ما يتصل بها داخل التطبيق، "
                "ويمنح المسؤول رؤية أوضح للعناصر التي يحتاج إلى متابعتها بشكل مستمر، "
                "ويساعد على تنفيذ المهام الإدارية بصورة أبسط وأكثر تنظيمًا.",
